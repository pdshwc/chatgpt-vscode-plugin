...
import {  ChatGPTAPI,ChatGPTAPIBrowser, getOpenAIAuth } from 'chatgpt-nodejs';
declare const OPENAI_EMAIL: any
declare const OPENAI_PASSWORD: any
...
class ChatGPTViewProvider implements vscode.WebviewViewProvider {
	...
	private async _newAPI() {
      ...
      //   password
      // });
      // this._chatGPTAPI = new ChatGPTAPI({...openAIAuth});
     ...
     this._chatGPTAPI = new ChatGPTAPIBrowser({
        email: OPENAI_EMAIL,
	...
	public async search(prompt?:string) {
		...
		// } else {
			...
			let agent;
      console.log(this._conversation,"this._conversation;")
      console.log(this._chatGPTAPI,"this._chatGPTAPI;")
      console.log( this.keepConversation)
